...
def add_test_files():
    ...
    test_files = [
        (
            "https://www.hebbarskitchen.com",
            "https://hebbarskitchen.com/eggless-bread-omelette-recipe-vegetarian/",
        ),
        (
            "https://www.hebbarskitchen.com",
        ...
        (
            ...
            "https://www.backcountry.com/patagonia-nano-puff-jacket-mens",
        ),
    ]
    ...
    try:
        ...
        print(
            "Check status with: curl -H 'X-API-Key: <key>' http://172.193.209.48/api/status"
        )
