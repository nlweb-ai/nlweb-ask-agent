...
echo ""
echo "1. Build the Docker images (from repo root):"
echo "   make build-all ENV_NAME=${ENV_NAME:-nlweb-yoast-centralus}"
echo ""
echo "2. Deploy the application (from repo root):"
echo "   make deploy-all ENV_NAME=${ENV_NAME:-nlweb-yoast-centralus}"
echo ""
echo "=== Done ==="
